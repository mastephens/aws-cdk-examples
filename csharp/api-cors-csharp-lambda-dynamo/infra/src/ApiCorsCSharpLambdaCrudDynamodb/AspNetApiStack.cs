...
public class AspNetApiStack : Stack
{
  internal AspNetApiStack(Construct scope, string id, IStackProps props = null) : base(scope, id, props)
  {
    ...
    var blogServiceLambda = new Function(this, "getBlogFunction", new FunctionProps
    {
      Runtime = Runtime.DOTNET_6,
      Code = Code.FromAsset("../app/SampleDynamoBlogAspNetApi/src/SampleDynamoBlogAspNetApi/bin/Release/net6.0/SampleDynamoBlogAspNetApi.zip"),
      Handler = "SampleDynamoBlogAspNetApi::SampleDynamoBlogAspNetApi",
